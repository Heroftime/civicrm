...
function pcpcontacttab_civicrm_tabs(&$tabs, $contactID) {

    $url = CRM_Utils_System::url('civicrm/contact/view/pcp', "reset=1&snippet=1&force=1&cid=$contactID");
    $tabs[] = array('id' => 'Personal-Campaign-Pages',
        'url' => $url,
...
function pcpcontacttab_civicrm_navigationMenu(&$menu) {
  _pcpcontacttab_civix_insert_navigation_menu($menu, NULL, array(
    'label' => ts('The Page', array('domain' => 'com.example.pcpcontacttab')),
    'name' => 'the_page',
